...
const deletePastEvent= async(req,res)=>{
    try{
        const result= await pastEvent.deleteOne({title:req.body.title, description: req.body.description});
...
const deleteCurrentEvent= async(req,res)=>{
    try{
        const result= await currentEvent.deleteOne({title:req.body.title, description: req.body.description});
...
const deleteUpcomingEvent= async(req,res)=>{
    try{
        const result= await upcomingEvent.deleteOne({title:req.body.title, description: req.body.description});
...
module.exports = {uploadPastEvent,getCurrentEvent,uploadUpcomingEvent,uploadCurrentEvent,deletePastEvent,deleteCurrentEvent,deleteUpcomingEvent,getUpcomingEvents,getPreviousEvent};